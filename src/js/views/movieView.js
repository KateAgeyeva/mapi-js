...
//CAST & CREW
const actors = (actor, index) => ` ${index+1}. ${actor}`;
            ...
            <div class="main-content__right-description">
                ...
                <div class="description-content">
                    ...
                    <div id="reviews" class="description-content__item" data-tab-content>
                       <p>The official IMDB score is ${movie.imdbRating}.
                       This has been calculated based on ${movie.imdbVotes} votes.</p>
                    </div>
...
export const updateTicketNum = movie =>{
